...
// 1. Define churchReportPageState and charting helper functions
const chartHelpersCode = `
// ============================================================================
...
function renderPeakLowChartSvg(dataPoints = [], options = {}) {
  ...
  let minIndex = -1;
  // Find lowest point that represents a meaningful low
...
// Insert chartHelpersCode right before renderCellMinistry
code = code.replace("function renderCellMinistry(activeTab = \"alecOverview\") {", chartHelpersCode + "\nfunction renderCellMinistry(activeTab = \"alecOverview\") {");

fs.writeFileSync(DASHBOARD_PATH, code, "utf8");
console.log("Successfully added Church Reports & Cell Attendance Analytics Engine!");
