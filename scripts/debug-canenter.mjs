...
vm.runInContext(`
  ...
  console.log("roleWorkspaceRoutes:", roleWorkspaceRoutes(activeUser));
  console.log("isRouteInRoleWorkspace followUp:", isRouteInRoleWorkspace("followUp", activeUser));
  console.log("resolveRouteAccess followUp:", resolveRouteAccess("followUp"));
`, context);
