...
check("cachebuster updated", /(?:20260806-runtime-provider-v8|20260819-members-runtime-fix-v[1-9]|20260821-[\w-]+|20260827-[\w-]+|20260902-[\w-]+|20260909-[\w-]+|20260910-[\w-]+)/.test(index));
