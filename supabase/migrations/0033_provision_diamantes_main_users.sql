-- ============================================================================
-- Migration 0033: Provision Diamantes Main Cell Users & Foundation Teacher
-- ============================================================================
-- 1. Líder de Célula Diamantes Main:
--    - Name: Filipe Chamango
--    - Email: diamantes.main@embaixadadecristo.org
--    - Auth UID: 473e4df5-883c-499a-a42e-223495c266d1
--    - Roles & Modules: Cell Leader (Diamantes Main + Group Diamantes), Follow-Up,
--      Foundation School Teacher (manage students, attendance, tests, exam, but cannot create classes), Reports
--
-- 2. Assistente de Célula Diamantes Main:
--    - Name: Michael Juma
--    - Email: assistant.diamantes.main@embaixadadecristo.org
--    - Auth UID: 1be83c02-cb16-4cf3-a246-58bd0ef1953f
--    - Roles & Modules: Cell Assistant (Diamantes Main + Group Diamantes, reports as main cell)
-- ============================================================================

DO $$
DECLARE
  v_church_id uuid := 'a1111111-1111-4111-8111-111111111101'::uuid; -- E.C. Maputo Central – Sede
  v_cell_id text := '3749602f-2f92-43a3-8db5-e96ee8a7a438'; -- Diamantes Main
  v_cell_group_id text := '334021eb-7658-4e26-8239-1a4f5c80409d'; -- Grupo Diamantes / Blossom
...
BEGIN
  ...
  -- 3. PROVISIONAR LÍDER: Filipe Chamango (diamantes.main@embaixadadecristo.org)
  ...
  -- 4. PROVISIONAR ASSISTENTE: Michael Juma (assistant.diamantes.main@embaixadadecristo.org)
