...
-- 2. Grant SELECT and UPDATE to authenticated users only
...
-- 5. Policy: Authenticated users can view user profiles (required for resolving internal profile upon login)
...
ON CONFLICT (id) DO UPDATE SET
  ...
  has_dashboard_access = EXCLUDED.has_dashboard_access,
