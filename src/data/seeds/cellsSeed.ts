  ...
  CELL_GROUP_DEFINITIONS.forEach((def, gIndex) => {
    ...
    for (let i = 1; i <= count; i += 1) {
      ...
      rows.push({
        ...
        primary_leader_user_id: seq === 1 ? "u-7" : null,
        primary_leader_name: seq === 1 ? "Cell Leader Demo" : `Líder ${i}`,
        assistant_leader_user_ids: seq === 1 ? ["u-cell-assistant"] : [],
        assistant_leader_names: seq === 1 ? ["Cell Assistant Demo"] : [],
