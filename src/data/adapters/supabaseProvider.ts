...
function sanitizeCandidateRow(record: any): Record<string, unknown> {
  ...
  map.prison_representatives = createPilotRepository<any>({ list: () => supabaseList<any>("prison_representatives"), create: (record) => supabaseCreate<any>("prison_representatives", record), update: (id, record) => supabaseUpdate<any>("prison_representatives", id, record), remove: (id) => supabaseDelete("prison_representatives", id) }) as EntityRepository<unknown>;
  ...
  map.prison_participants = createPilotRepository<any>({ list: () => supabaseList<any>("prison_participants"), create: (record) => supabaseCreate<any>("prison_participants", record), update: (id, record) => supabaseUpdate<any>("prison_participants", id, record), remove: (id) => supabaseDelete("prison_participants", id) }) as EntityRepository<unknown>;
  ...
  map.prison_follow_ups = createPilotRepository<any>({ list: () => supabaseList<any>("prison_follow_ups"), create: (record) => supabaseCreate<any>("prison_follow_ups", record), update: (id, record) => supabaseUpdate<any>("prison_follow_ups", id, record), remove: (id) => supabaseDelete("prison_follow_ups", id) }) as EntityRepository<unknown>;
  ...
  map.prison_materials_requests = createPilotRepository<any>({ list: () => supabaseList<any>("prison_materials_requests"), create: (record) => supabaseCreate<any>("prison_materials_requests", record), update: (id, record) => supabaseUpdate<any>("prison_materials_requests", id, record), remove: (id) => supabaseDelete("prison_materials_requests", id) }) as EntityRepository<unknown>;
  ...
  map.cell_groups = createPilotRepository<any>({ list: cellMinistrySb.listCellGroups, getById: cellMinistrySb.getCellGroupById, create: cellMinistrySb.createCellGroup, update: cellMinistrySb.updateCellGroup, remove: cellMinistrySb.deleteCellGroup }) as EntityRepository<unknown>;
  map.cells = createPilotRepository<any>({ list: cellMinistrySb.listCells, getById: cellMinistrySb.getCellById, create: cellMinistrySb.createCell, update: cellMinistrySb.updateCell, remove: cellMinistrySb.deleteCell }) as EntityRepository<unknown>;
